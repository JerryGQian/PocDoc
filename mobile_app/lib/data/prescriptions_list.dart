...
class PrescriptionsList {
  static List<Medication> medications = [
    ...
    Medication(
      ...
      category: MedicationCategory.cruciferous,
    ...
    Medication(
      ...
      category: MedicationCategory.leafy,
    ...
    Medication(
      ...
      category: MedicationCategory.citrus,
    ...
    Medication(
      ...
      category: MedicationCategory.tropical,
    ...
    Medication(
      ...
      category: MedicationCategory.fungus,
    ...
    Medication(
      ...
      category: MedicationCategory.stoneFruit,
    ...
    Medication(
      ...
      category: MedicationCategory.tuber,
    ...
    Medication(
      ...
      category: MedicationCategory.root,
    ...
    Medication(
      ...
      category: MedicationCategory.gourd,
